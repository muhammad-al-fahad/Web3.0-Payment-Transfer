import useTransaction, { structuredTransactionProps } from "../hooks/useTransaction";
import { shortenAddress } from "../utils/shortenAddress";

const TransactionsCard = ({ addressTo, addressFrom, timestamp, amount }: structuredTransactionProps) => {
...
const Transactions = () => {
  const { transactions, currentAccount } = useTransaction();
